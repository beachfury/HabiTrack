...
// Combinable CSS effects system organized by property type and theme category
...
// Parse CSS string to extract individual properties
...
// Merge CSS strings, combining properties intelligently
function mergeCSSStrings(existing: string, newCSS: string): string {
...
// Remove effect from CSS string
function removeEffectFromCSS(css: string, effectCSS: string): string {
...
// Check if an effect is active in the current CSS
function isEffectActive(css: string, effectCSS: string): boolean {
  if (!css) return false;
